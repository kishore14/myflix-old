...
#Video.create(title: 'Family Guy', description: '', small_cover_url: '/tmp/family_guy.jpg')
#Video.create(title: 'Futurama', description: '', small_cover_url: '/tmp/futurama.jpg')
#Video.create(title: 'South Park', description: '', small_cover_url: '/tmp/south_park.jpg')
